    ...
    <>
      ...
      >
        ...
        {movement?.isBase ? (
          ...
          <g transform={`rotate(${degrees})`} style={{ fill: ship.color }}>
        ...
        {ship && rotation === null && !movement?.isBase ? (
          <g className="ship-menu">
            <g transform="translate(0 -0.8)" onClick={() => setRotation(ship.rotation)}>
              <circle r="0.3" />
            ...
            <g transform="rotate(-60 0 0) translate(0 -0.8)" onClick={onMoveStart}>
              <circle r="0.3" />
              <path
            ...
            <g transform="rotate(-120 0 0) translate(0 -0.8)" onClick={() => deleteShip(ship.name)}>
              <circle r="0.3" />
              <path
